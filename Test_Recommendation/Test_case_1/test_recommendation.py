...
class TestRecommendation(unittest.TestCase):
	...
	self.driver = webdriver.Remote(command_executor='http://'+self.docker_address+':4444/wd/hub',desired_capabilities=DesiredCapabilities.FIREFOX)
        ...
        self.article_link="http://"+self.address +"/articles/"
