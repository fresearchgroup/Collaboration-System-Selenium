...
class test(unittest.TestCase):
    ...
    def test_article_stateChanged(self):
        url_api = self.url_basic + 'logapi/event/article/statusChanged/' + self.article_id + '/'
        ...
        url_api = self.url_basic + 'logapi/event/article/statusChanged/' + str(self.article_id) + '/'
        result = requests.get(url_api, headers = self.headers).json()
        new_result={}
        for key,value in result.iteritems():
            new_result[key.lower()] = value
